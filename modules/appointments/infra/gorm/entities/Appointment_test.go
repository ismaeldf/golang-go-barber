...
func TestNewAppointment(t *testing.T) {
	t.Run("should be able to create a new entitie appointment", func(t *testing.T) {
		appointment, _ := NewAppointment("111", time.Now())

		require.Equal(t, appointment.ProviderId, appointment.ProviderId)
	})

	t.Run("should be not able to create a new entitie appointment", func(t *testing.T) {
